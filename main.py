...
sideFrameSelectTable = c.CTkOptionMenu(sidebar, values=["Student Table", "Result Table"], command=SelectUpdateValue)
...
deleteLabel = c.CTkLabel(Tabs.tab("Update Student Data"), text="You want to Update ")
deleteLabel.grid(row=0, column=0, sticky="ew", padx=5, pady=5)

DeleteOption = c.CTkOptionMenu(Tabs.tab("Update Student Data"), width=400, command=SelectUpdateValue
                               , values=["Name", "Class",
...
deleteRollLabel = c.CTkLabel(Tabs.tab("Delete Student Data"), text="Roll Number ", width=150)
deleteRollLabel.grid(row=0, column=0, sticky="news", padx=5, pady=5)

deleteEntryRoll = c.CTkEntry(Tabs.tab("Delete Student Data"), width=300,
                             placeholder_text="of whose data is to be "
                                              "Deleted")
deleteEntryRoll.grid(row=0, column=1, columnspan=2, sticky="news", padx=5, pady=5)

EnterButtonDelete = c.CTkButton(Tabs.tab("Delete Student Data"), text="Enter")
