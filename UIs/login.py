...
student = c.CTkRadioButton(login_frame, text="Student", variable=user_var, value=0, command=change_widgets)
student.grid(row=1, column=0, padx=10, pady=[20, 10])
admin = c.CTkRadioButton(login_frame, text="Admin", variable=user_var, value=1, command=change_widgets)
